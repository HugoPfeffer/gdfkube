              ...
              <div style={{padding: 8, borderBottom: "1px solid var(--ink-200)"}}>
                {[
                  ...
                  <div key={v.token}
                    ...
                    <button className="icon-btn" onClick={e => { e.stopPropagation(); copyText(v.token); }} title={`Copy ${v.token}`} style={{width: 22, height: 22, flex: "0 0 auto", marginTop: 1}}>
                      <Icons.copy size={11} />
                    </button>
                  </div>
                ))}
                ...
                {fields.map(f => {
                  ...
                  return (
                    <div key={f.id}
                      ...
                      <button className="icon-btn" onClick={e => { e.stopPropagation(); copyText(token); }} title={`Copy ${token}`} style={{width: 22, height: 22, flex: "0 0 auto", marginTop: 1}}>
                        <Icons.copy size={11} />
                      </button>
                    </div>
                  );
