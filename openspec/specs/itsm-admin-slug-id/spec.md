...
Ensure that Group and Form IDs in the ITSM admin SPA are deterministically auto-derived from the Display name via a shared `slugify` utility, preventing user-input errors and guaranteeing DNS-1123-compatible identifiers for downstream Keycloak, Gitea, and ArgoCD resources.
