...
function makeState(): DataState {
  return {
    ...
    users: [
      ...
      makeUser({ id: '4', username: 'ana.rodrigues', name: 'Ana Rodrigues', email: 'ana.r@fazenda.gov', role: 'operator', group: 'fazenda' }),
      makeUser({ id: '5', username: 'rafael.souza', name: 'Rafael Souza', email: 'r.souza@educacao.gov', role: 'operator', group: 'educacao' }),
    ],
    groups: [
